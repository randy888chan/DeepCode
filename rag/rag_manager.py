...
class RAGManager:
    ...
    async def generate_query_for_agent(self, agent_type: str, requirements: str = "") -> str:
        """
    ...
    async def analyze_with_agent(self, agent_type: str, requirements: str = "") -> Optional[str]:
        """
