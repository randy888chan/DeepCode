...
class RAGConfigManager:
    ...
    def load_config(self) -> RAGConfig:
        ...
        config_dict = {
            ...
            "enable_equation_processing": rag_config.get("enable_equation_processing", True),
            "working_dir": rag_config.get("working_dir", "./rag_storage"),
            
            # Embedding settings
            "embedding_model": rag_config.get("embedding", {}).get("model", "text-embedding-3-large"),
            "embedding_dimension": rag_config.get("embedding", {}).get("dimension", 3072),
            "max_token_size": rag_config.get("embedding", {}).get("max_token_size", 8192),
