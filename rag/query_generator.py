...
class QueryGenerator:
    ...
    async def generate_query(self, context: QueryGenerationContext) -> List[str]:
        ...
        if not self.llm_function:
            ...
            return self._get_fallback_query(context.agent_type, context.user_requirements)
    ...
    def _build_dynamic_prompt(self, context: QueryGenerationContext) -> str:
        ...
        if context.analysis_depth == "focused":
            ...
            instruction = "Generate 1 comprehensive query that captures all essential aspects."
    ...
    def _get_fallback_query(self, agent_type: str, requirements: Optional[str] = None) -> str:
        """
