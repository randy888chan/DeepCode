...
async def append_to_file(
    file_path: str, code_content: str, add_newline: bool = True
) -> str:
    """
...
async def insert_code_at_line(
    file_path: str, line_number: int, code_content: str
) -> str:
    """
...
async def replace_code_section(
    file_path: str, start_line: int, end_line: int, new_code_content: str
) -> str:
    """
...
@mcp.tool()
async def create_project_structure(base_path: str, structure: Dict[str, Any]) -> str:
    """
    ...
    try:
        ...
        result = {
            ...
            "total_directories": len(
                [i for i in created_items if i["type"] == "directory"]
            ),
...
@mcp.tool()
async def validate_file_syntax(file_path: str, language: str = "auto") -> str:
    """
...
async def list_project_files(
    project_path: str, file_extensions: List[str] = None, max_depth: int = 10
) -> str:
    """
...
if __name__ == "__main__":
    ...
    print(
        "  • insert_code_at_line    - 在指定行插入代码 / Insert code at specific line"
    )
